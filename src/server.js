...
import { user as userService, blog as blogService} from './services';
import config from './configs/server';

const server = express();

mongoose.connect(config.mongo.reduxblog.url);
...
server.use(config.apiRoot + '/user', userService);
server.use(config.apiRoot + '/blog', blogService);
